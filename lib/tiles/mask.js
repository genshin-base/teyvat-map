 ...
 * @param {number} height
 */
export async function prepareMask(cfg, tileSize, width, height) {
	...
	const shadows = cfg.shadows.map(x => ({ ...x, blur: (x.blur / 1024) * tileSize }))
...
/**
 * @param {import('canvas').NodeCanvasRenderingContext2D} outRC
